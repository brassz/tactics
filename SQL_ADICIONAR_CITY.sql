-- SQL para adicionar campo CITY na tabela USERS
-- Execute no banco: https://zwazrwqrbghdicywipaq.supabase.co

-- Adicionar campo city (cidade selecionada pelo cliente)
ALTER TABLE users ADD COLUMN IF NOT EXISTS city TEXT;

-- Criar índice para pesquisa por cidade
CREATE INDEX IF NOT EXISTS idx_users_city ON users(city);

-- Adicionar campo company se não existir
